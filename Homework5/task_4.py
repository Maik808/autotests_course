...
def scrabble(word):
    """
    Функция, считает кол-во очков (points), полученное за слово (word) согласно данным из задачи
    :param word: строка
    :return: результирующее число - расчетная "стоимость" слова
    """
    # Здесь нужно написать код
    points = 0
    letter_points = {1: 'авеёинорст', 2: 'дклмпу', 3: 'бгья', 4: 'йы', 5: 'жзхцч', 8: 'фшэю', 10: 'щ', 15: 'ъ'}
    for x in word:
