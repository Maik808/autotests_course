...
class PublicTransport:
    ...
    def info(self):
        ...
        :return: Строка с информацией о транспорте Марка, Цвет, год выпуска и мощность двигателя
        """
...
class Bus(PublicTransport):
    ...
    def park(self):
        """
        Свойство park возвращает значение park
    ...
    def park(self, park):
        """
        Свойство возвращает значение park,
        а при присвоении проверяет номер парка, что он в диапазоне от 1000 до 9999
        :param park: Парк приписки автобуса
        """
...
class Tram(PublicTransport):
    ...
    def how_long(self):
        """
        Свойство how_long вычисляет время за прохождение маршрута по формуле max_speed/(4*path)
